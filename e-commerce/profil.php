...
<body>
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-8">
        <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="daftarbarang.php"
                                class="inline-flex items-center ms-1 text-sm font-medium text-gray-700 hover:text-primary-600 dark:text-gray-400 dark:hover:text-white md:ms-2">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="inline-flex items-center ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">
                                <svg class="me-2 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2"
            ...
            <div
                class="grid grid-cols-2 gap-6 border-b border-t border-gray-200 py-2 dark:border-gray-700 md:py-8 lg:grid-cols-4 xl:gap-16">
                <div>
                    ...
                    <h6 class="mb-2 text-gray-500 dark:text-gray-400">Orders made</h6>
                ...
                <div>
                    ...
                    <h6 class="mb-2 text-gray-500 dark:text-gray-400">Items added</h6>
                    <span class="flex items-center text-2xl font-bold text-gray-900 dark:text-white">
                        <?php
                ...
                <div>
                    ...
                    <h6 class="mb-2 text-gray-500 dark:text-gray-400">Hours of online</h6>
                ...
                <div>
                    ...
                    <h6 class="mb-2 text-gray-500 dark:text-gray-400">Total Purchase</h6>
                    <span class="flex items-center text-2xl font-bold text-gray-900 dark:text-white">
                        <?php
                        // Asumsikan jumlah item dibeli diperoleh dari database
                        $jumlah_dibeli = $database->tampil($_SESSION['username'], "dibeli")[0]; // Ambil jumlah item dibeli
                        $harga_per_item = 120000; // Harga per item
                        $total_harga = $jumlah_dibeli * $harga_per_item; // Hitung total harga
                        ...
                        echo format_rupiah($total_harga); // Tampilkan total harga
                        ?>
                        <span
                            class="ms-2 inline-flex items-center rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300">
                            <svg class="-ms-1 me-1 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="py-1 md:py-8">
                ...
                <button type="button" data-modal-target="accountInformationModal2"
                    ...
                    class="inline-flex items-center justify-center text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
